...
def step_wifi():
    ...
    # WiFi supported: connect (FAST FAIL)
    try:
        _gc()
        ...
        ok, ip, status = wifi.connect(
            ...
            timeout_s=4,   # was 10; faster fail
            retry=0        # was 1; avoid long retry storm
        )
...
if _btn_hal_ok:
    ...
    # Stop cleanly at REPL so you can patch src/hal/board_esp32.py
    while True:
        time.sleep(5)